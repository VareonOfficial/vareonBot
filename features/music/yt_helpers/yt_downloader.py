...
from features.music.utils import run_download, update_progress 
from features.music.yt_helpers.ytmetadata import apply_youtube_postprocess
...
async def scrape_youtube_to_download(
    ...
    if target == "music_on_telegram":
        ...
        os.makedirs(os.path.join(temp_path, task_id), exist_ok=True)
    ...
    base_cmd = [
        ...
        *cookie_args,
        "-o", os.path.join(download_path, f"(title)s.%(ext)s"),
    ]
