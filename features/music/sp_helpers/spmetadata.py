...
from features.music.sp_helpers.splyrics import SpotifyClient
from features.music.utils import extract_track_id, upload_song_to_telegram
...
async def apply_spotify_postprocess(
    ...
    async def update_progress_msg(text):
        try:
            ...
            return None
    progress_msg = await update_progress_msg(
    ...
    session_data = sessions.get(update.effective_user.id, {})
